...
public class MyOauthWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<Result> handleOAuth2Exception(OAuth2Exception e) {
        ...
        ResultEnum enums = ResultEnum.SYS_ERROR;
        enums.setCode(e.getHttpErrorCode());
        enums.setMessage(e.getMessage());
        return new ResponseEntity<>(Result.build(enums), headers, HttpStatus.OK);
